...
import { Command, CommandStack, StackListener } from './command';
import { DirectEdit } from './directEdit';
import "./editor.css";
import { Point } from './geometry';
import { DiagramModel } from './model';
import { DiagramView, Measurer, Style } from './renderer';
import { DiagramContext, IdleState, State } from './states';
...
class Editor {
    ...
    constructor(options: Options) {
        ...
        this.svg.add('defs')
            .add("marker").id("triangle").viewBox("0 0 10 10")
                  .refX("10").refY("5")
                  .markerUnits("strokeWidth")
                  .markerWidth("10").markerHeight("10")
                  .orient("auto-start-reverse")
                .add('path').d("M 0 0 L 10 5 L 0 10 z").fill("black");
